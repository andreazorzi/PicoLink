...
<html lang="und" dir="auto" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="background-color: #ebf5ff; padding: 10px; word-spacing: normal;">
      ...
      <img alt src="{{ImageController::toBase64('images/logo.png')}}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="400" height="auto">
      ...
      <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tbody>
          <tr>
            <td style="background-color:#ffffff;vertical-align:top;padding:20px;padding-right:0px;padding-left:0px;">
      ...
      <div style="font-family:helvetica;font-size:25px;line-height:1;text-align:left;color:#0A5399;">Richiesta di reset della password</div>
      ...
      <p style="border-top:solid 4px #0A5399;font-size:1px;margin:0px auto;width:100%;">
      </p>
      
      <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 4px #0A5399;font-size:1px;margin:0px auto;width:550px;" role="presentation" width="550px" ><tr><td style="height:0;line-height:0;"> &nbsp;
</td></tr></table><![endif]-->
      ...
      <div style="font-family:helvetica;font-size:16px;line-height:20px;text-align:left;color:#000000;">Gentile {{$user->name}},<br>
                    <p>
      ...
      <div style="font-family:helvetica;font-size:12px;line-height:1;text-align:center;color:#0A5399;">{{config("app.name")}}</div>
